                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form method="POST" action="{{ url('admin/post',[$post->id]) }}">
                                    ...
                                    <div class="form-group">
										<div class="col-">
											<label for="image">Pos Image</label>																				
											<img class="thumbnail img-responsive" src="{!! asset('asset/images/'.$post->image) !!}" alt="" width="25%">
											<input type="file" name="image" accept="image/{{$post->image}}" >
										</div>										
									</div>
									<div class="form-group">
                                        {{csrf_field()}}
